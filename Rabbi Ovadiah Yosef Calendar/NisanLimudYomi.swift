//
//  NisanLimudYomi.swift
//  Rabbi Ovadiah Yosef Calendar
//
//  Created by Elyahu Jacobi on 4/8/25.
//

import Foundation

public class NisanLimudYomi {

    public static func getNisanLimudYomiTitle(day: Int) -> String {
        switch (day) {
        case 1 : return "נַחְשׁ֥וֹן בֶּן־עַמִּינָדָ֖ב"
            case 2 : return "נְתַנְאֵ֣ל בֶּן־צוּעָ֑ר"
            case 3 : return "אֱלִיאָ֖ב בֶּן־חֵלֹֽן";
            case 4 : return "אֱלִיצ֖וּר בֶּן־שְׁדֵיאֽוּר";
            case 5 : return "שְׁלֻֽמִיאֵ֖ל בֶּן־צוּרִֽישַׁדָּֽי";
            case 6 : return "אֶלְיָסָ֖ף בֶּן־דְּעוּאֵֽל";
            case 7 : return "אֱלִֽישָׁמָ֖ע בֶּן־עַמִּיהֽוּד";
            case 8 : return "גַּמְלִיאֵ֖ל בֶּן־פְּדָהצֽוּר";
            case 9 : return "אֲבִידָ֖ן בֶּן־גִּדְעֹנִֽי";
            case 10 : return "אֲחִיעֶ֖זֶר בֶּן־עַמִּישַׁדָּֽי";
            case 11 : return "פַּגְעִיאֵ֖ל בֶּן־עׇכְרָֽן";
            case 12 : return "אֲחִירַ֖ע בֶּן־עֵינָֽן";
            case 13 : return "בְּהַעֲלֹֽתְךָ֙ אֶת־הַנֵּרֹ֔ת";
            default : return "";
        };
    }

    public static func getNisanLimudYomiReading(day: Int) -> String {
        switch (day) {

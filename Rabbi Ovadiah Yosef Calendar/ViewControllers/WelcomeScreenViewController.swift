...
class WelcomeScreenViewController: UIViewController {
    ...
    @IBAction func haskamot(_ sender: UIButton) {
        var alertController = UIAlertController(title: "Choose a haskama to view".localized(), message: "Multiple rabbanim have given their haskama/approval to this app. Choose which one you would like to view.".localized(), preferredStyle: .alert)

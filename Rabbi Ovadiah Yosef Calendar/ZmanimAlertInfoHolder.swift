...
"""
        ...
        if title == zmanimNames.getMinchaGedolaString() {
            if Locale.isHebrewLocale() {
                ...
                return "Minḥa Gedolah, literally \"Greater Minḥa\", is the earliest time a person can say Minḥa. " +
                "It is also the preferred time a person should say Minḥa according to some poskim.\n\n" +
                "It is called Minḥa Gedolah because there is a lot of time left until sunset.\n\n" +
        ...
        if title == zmanimNames.getMinchaKetanaString() {
            if Locale.isHebrewLocale() {
                ...
                return "Minḥa Ketana, literally \"Lesser Minḥa\", is the most preferred time a person can say Minḥa according to some poskim.\n\n" +
                "It is called Minḥa Ketana because there is less time left until sunset.\n\n" +
        ...
        if title == zmanimNames.getSunsetString() {
            if Locale.isHebrewLocale() {
                ...
                "It should be noted that many poskim, like the Mishna Berura, say that a person should ideally say Minḥa BEFORE sunset " +

//
//  WeeklyHaftorahReading.swift
//  Rabbi Ovadiah Yosef Calendar
//
//  Created by Elyahu Jacobi on 6/3/24.
//
...
public class WeeklyHaftarahReading {
     ...
     */
    public static func getThisWeeksHaftarah(jewishCalendar:JewishCalendar) -> String {
        var result = "מפטירין ";
        ...
        case .LECH_LECHA:
            ...
            case .CHUKAS_BALAK:
                ...
                break;
            case .PINCHAS:
                if (jewishCalendar.getJewishMonth() == JewishCalendar.TAMMUZ) {
        ...
        case .HAAZINU:
                ...
                } else if (jewishCalendar.getJewishMonth() == JewishCalendar.ELUL) {// Definitely before Yom Kippur
                    result += "\"שובה\" הושע י\"ד";
                }
                break;
        case .VZOS_HABERACHA:

...
- (nullable NSDate *)alos72Zmanis {
    ...
    return [[self sunrise] dateByAddingTimeInterval:shaahZmanis*-1.2];
}
...
- (nullable NSDate *) tzais72Zmanis{
    ...
    return [[self sunset] dateByAddingTimeInterval:shaahZmanis*1.2];
}
...
- (nullable NSDate *) tzais90Zmanis{
    ...
    return [[self sunset] dateByAddingTimeInterval:shaahZmanis*1.5];
}
...
- (nullable NSDate *) tzais96Zmanis{
    ...
    return [[self sunset] dateByAddingTimeInterval:shaahZmanis*1.6];
}
...
- (nullable NSDate *) tzais120Zmanis{
    ...
    return [[self sunset] dateByAddingTimeInterval:shaahZmanis*2.0];
}
